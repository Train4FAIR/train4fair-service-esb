...
//	}
	...
	Wagons[] getWagonsByTrainId(@PathVariable String id) throws Exception {
		Train train = facade.findTrainById(id);
	...
	Train saveTrainAndDataciteFirstFlow(@RequestBody String trainStr, @PathVariable String trainId)
		...
		Train train = facade.saveTrainAndDataciteFirstFlow(trainStr);
		return train;
	}
...
//			}
	...
	@GetMapping(value = "/train/all/{trainId}", produces = MediaType.APPLICATION_JSON_VALUE)
